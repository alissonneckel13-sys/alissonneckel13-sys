...
* 🛠️ **Ferramentas e Ferramental Técnico:** Git, GitHub para controle de versão, uso de terminal/CLI para execução de scripts e ferramentas de automação/identificação.
